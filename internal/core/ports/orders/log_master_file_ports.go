...
type ILogMasterFileRepository interface {
	...
	GetLogMasterFiles(param pagination.PaginationParams[filters.LogMasterFileFilter]) (*pagination.Pagination[[]models.LogMasterFile], error)
...
type ILogMasterFileService interface {
	...
	GetLogMasterFiles(param pagination.PaginationParams[filters.LogMasterFileFilter]) pagination.Pagination[[]models.LogMasterFile]
